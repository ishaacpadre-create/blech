  ...
  return (
    <div style={{ minHeight: "100vh", background: c.bg, fontFamily: "'Quicksand', system-ui, sans-serif", color: c.text, transition: "background 0.3s, color 0.3s", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ position: "fixed", inset: 0, pointerEvents: "none", zIndex: 0, overflow: "hidden" }}>
        <div style={{ position: "absolute", top: "-5%", right: "-10%", width: "600px", height: "600px", borderRadius: "50%", background: isDark ? "radial-gradient(circle, rgba(255,140,66,0.15) 0%, transparent 70%)" : "radial-gradient(circle, rgba(255,140,66,0.18) 0%, transparent 70%)", animation: "blobFloat1 20s ease-in-out infinite", filter: "blur(60px)" }} />
        <div style={{ position: "absolute", bottom: "0%", left: "-10%", width: "550px", height: "550px", borderRadius: "50%", background: isDark ? "radial-gradient(circle, rgba(142,45,226,0.12) 0%, transparent 70%)" : "radial-gradient(circle, rgba(142,45,226,0.14) 0%, transparent 70%)", animation: "blobFloat2 25s ease-in-out infinite", filter: "blur(60px)" }} />
        <div style={{ position: "absolute", top: "35%", left: "40%", width: "500px", height: "500px", borderRadius: "50%", background: isDark ? "radial-gradient(circle, rgba(232,99,124,0.1) 0%, transparent 70%)" : "radial-gradient(circle, rgba(62,193,211,0.14) 0%, transparent 70%)", animation: "blobFloat3 18s ease-in-out infinite", filter: "blur(60px)" }} />
        <div style={{ position: "absolute", inset: 0, backgroundImage: isDark ? "radial-gradient(rgba(255,255,255,0.04) 1.2px, transparent 1.2px)" : "radial-gradient(rgba(0,0,0,0.06) 1.2px, transparent 1.2px)", backgroundSize: "28px 28px" }} />
      </div>
      <style>{`
